  ...
  <div class="order-right">
    <div class="order-content">
      ...
      <div class="orders">
        ...
        <table class="order-item" v-for="item in orderdata" :key="item.id">
          <thead>
            <tr>
              <th colspan="5">
      ...
      <div class="choose-order">
        <el-pagination v-model:currentPage="currentpage" v-model:page-size="limit" :background="true"
...
import { reqorderdata } from '../../../api/trade'
export default defineComponent({
  ...
  setup() {
    ...
    const getdata = async () => {
      const result: any = await reqorderdata(currentpage.value, limit.value)
      if (result.code == 200) {
        total.value = result.data.total
        orderdata.push(...result.data.records)
      }
    }
    getdata()
    return {
